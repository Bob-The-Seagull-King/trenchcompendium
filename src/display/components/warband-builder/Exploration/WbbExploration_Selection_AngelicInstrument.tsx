...
interface WbbExploration_Selection_AngelicInstrument_Props {
    onChange?: (selected: Fighter | null) => void;
}

const WbbExploration_Selection_AngelicInstrument: React.FC<
    WbbExploration_Selection_AngelicInstrument_Props
> = ({ onChange }) => {

    // @TODO: list of fighters that have an instrument equipped
    ...
    return (
        <div className="WbbExploration_Selection_AngelicInstrument mb-3">
...
export default WbbExploration_Selection_AngelicInstrument;

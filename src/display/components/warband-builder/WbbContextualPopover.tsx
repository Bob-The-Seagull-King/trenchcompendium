                ...
                <Modal.Body>
                    ...
                    <p>
                        ...
                        <i>
                            ...
                            <br/>
                            {'You will receive: '}
                            {Math.floor((item as RealWarbandPurchaseEquipment).purchase.GetTotalDucats()/(((item as RealWarbandPurchaseEquipment).purchase.FullSell)? 1 : 2)) + " Ducats and " + (item as RealWarbandPurchaseEquipment).purchase.GetTotalGlory() + " Glory"}
                        </i>
                        }
                    </p>
                </Modal.Body>

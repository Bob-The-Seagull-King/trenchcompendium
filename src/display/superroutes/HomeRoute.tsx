            ...
            <div className="row justify-content-center m-0 p-0">
                <div className="col-lg-10 col-md-12 col-sm-12 col-xs-12 col-12">
                    ...
                    <div className="row row-cols-lg-3 row-cols-md-3 row-cols-sx-1 row-cols-xs-1 row-cols-1">
                        ...
                        <div className="col softpad">
                            <div className="basestructure pageaccessbox borderstyler subborderdefault hovermouse" onClick={() => NavigateHome("compendium/scenario/")}>
                                <FontAwesomeIcon icon={faChess} className="pageaccestext"/>
                                <h1 className="pageaccestext">
                                    SCENARIOS
                                </h1>
                            </div>
                    ...
                    <div className="row row-cols-lg-3 row-cols-md-3 row-cols-sx-1 row-cols-xs-1 row-cols-1">
                        ...
                        <div className="col softpad">
                            <div className="basestructure pageaccessbox borderstyler subborderdefault hovermouse" onClick={() => NavigateHome("compendium/exploration/")}>
                        ...
                        <div className="col softpad">
                            <div className="basestructure pageaccessbox borderstyler subborderdefault hovermouse" onClick={() => NavigateHome("compendium/injury/")}>
                        ...
                        <div className="col softpad">
                            <div className="basestructure pageaccessbox borderstyler subborderdefault hovermouse" onClick={() => NavigateHome("compendium/skill/")}>
                                <FontAwesomeIcon icon={faDumbbell} className="pageaccestext"/>
                                <h1 className="pageaccestext">
                                    SKILL TABLES
                                </h1>
                            </div>
                    ...
                    <div className="row row-cols-lg-1 row-cols-md-1 row-cols-sx-1 row-cols-xs-1 row-cols-1">
                        ...
                        <div className="col softpad">
                            <div className="basestructure pageaccessbox borderstyler subborderdefault hovermouse" onClick={() => NavigateHome("tools/randomscenario/")}>
                                <FontAwesomeIcon icon={faQuestion} className="pageaccestext"/>
                                <h1 className="pageaccestext">
                                    RANDOM SCENARIO
                                </h1>
                            </div>

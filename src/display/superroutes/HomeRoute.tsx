...
import { faBook, faChess, faGun, faHeart, faHeartPulse, faKey, faList, faMap, faPeopleGroup, faPersonMilitaryRifle, faQuestion, faRuler, faSquare } from '@fortawesome/free-solid-svg-icons'
